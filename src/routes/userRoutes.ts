...
userRoute.post('/v1/auth/login', rateLimiter(20, 30), login);

// OTP-Based Sign-Up Routes
userRoute.post('/v1/auth/signup/request-otp', rateLimiter(20, 30), requestOtp);
userRoute.post('/v1/auth/signup/verify-otp', rateLimiter(20, 30), verifyOtp);
